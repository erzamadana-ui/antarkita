#!/usr/bin/env bash
# =====================================================================
# scripts/uji-rollback.sh — uji rollback migrasi Finpay v3 (0105–0110) di harness LOKAL
#
...
#   2. migrasi penuh (0105–0110)                               → skema A1
#   3. rollback penuh 0110_down … 0105_down                    → skema B;  B harus = C
#   4. migrasi ulang                                           → skema A2; A2 harus = A1
#   5. rollback sebagian (0110_down, 0109_down) + migrasi ulang → skema A3; A3 harus = A1
...
info "2. migrasi 0105–0110"
migrate up1
dump "$OUT/A1-up.sql"

info "3. rollback penuh 0110 → 0105"
down 0110 0109 0108 0107 0106 0105
dump "$OUT/B-down.sql"
...
[[ "$n" == "0" ]] && lulus "catatan _lokal.migrasi 0105–0110 terhapus" || jatuh "_lokal.migrasi masih mencatat $n migrasi v3"
...
info "5. rollback sebagian (0110, 0109) + migrasi ulang"
down 0110 0109
migrate up3
